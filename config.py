...
# =============================================================================
# ⚠️ 警告：以下默认样式已锁定，请勿修改！
# /learn 功能只会在 visual_styles/ 目录创建新样式，不会修改这里的默认样式
# 如需添加新样式，请使用 /learn 或手动在 visual_styles/ 目录创建 YAML 文件
# =============================================================================

# 锁定的默认样式ID列表 - 这些样式不可被 /learn 覆盖
LOCKED_STYLE_IDS = ["blueprint", "modern", "academic", "creative"]
